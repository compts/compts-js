...
window.control=control; var domCoreAssign=(function () { var doc_set=function (idss) { var domm=[]; var ps_ext=new PsExtender();
...
PsExtender.prototype.dom={
    ...
    "html": {
        "hasClass" (s, klass) { var r = new RegExp("(?:^| )(" + klass + ")(?: |$)"),
                m = (""+s).match(r);
        ...
        "tag_value" (tar, ar) { var tar_sub=tar.split("=>");
    ...
    "init" (s, ar) { var ar_s=[]; var chd_dom=s.toString().match(/^[#.\w]{0,1}/g);
